class QuizzDisplay{
  public static void homePage (){
    ...
    System.out.println("A chaque fois que vous obtenez la bonne réponse, vous gagnez un gallion et vous passez à la question suivante. A n'importe quel moment vous pouvez sortir du jeu et partir avec les gallions que vous avez obtenus. Le jeu prendra fin lorsque vous aurez obtenu 15 gallions (soit 7 395 noises!!)");
